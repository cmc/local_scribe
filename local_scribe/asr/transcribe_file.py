...
def transcribe_with_parakeet(
    ...
    from local_scribe.asr.backends.parakeet_backend import transcribe_to_deepgram
...
def run_diarization(
    ...
    *,
    ...
    from local_scribe.asr.backends.diarization_backend import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    if payload is None:
        try:
            ...
            print("   Is the ASR server running? (./run.sh start  -or-  uvicorn local_scribe.asr.asr_server:app --port 8000)",
                  file=sys.stderr)
            return 2
