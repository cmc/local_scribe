...
- [`SECURITY.md`](../SECURITY.md) — threat model + defense layers in prose
...
14. [Threat model × defense layers](#14-threat-model--defense-layers)
...
| crossed `-.X.->` | request that is *intentionally refused* by a defense layer |
...
## 14. Threat model × defense layers
...
toggle so the firewall is the only line of defense; PostHog is also
